 ...
 * @author VINH
 */
@WebServlet(name = "getFullSongOfSearchController", urlPatterns = {"/getSong"})
public class getFullSongOfSearchController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Song> list = db.getAllSongOfSearch(search);
        out.println("<div class=\"search_type-des\"><span class=\"fs-2\">Bài Hát</span></div>");
        for (Song s : list) {
