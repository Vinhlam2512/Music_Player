<%-- 
    Document   : search.jsp
    Created on : Mar 7, 2022, 9:22:03 PM
    Author     : VINH
--%>
...
<html>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="./kham-pha">Khám Phá</a>
                            </li>
                            <li class="nav-item">
            ...
            <div class="container">
                ...
                <div class="song">
                    <div class="search_type d-flex justify-content-between align-items-center">
                        <div class="search_type-des"><span class="fs-2">Bài Hát</span></div>
                    </div>
                    <c:forEach items="${listSongs}" var="l">
                        <div class="chart_content-song">
                            ...
                            <div class="right me-5 position-relative" style="width: 3%;">
                                <button id="add" style="">
                                    <svg onclick="insert(23)" id="unliked" style="height: 38px; width: 38px;" fill="white"
                                         height="480pt" viewBox="0 -20 480 480" width="480pt" xmlns="http://www.w3.org/2000/svg">
                                    <path
                ...
                <div class="playList">
                    ...
                    <div class="row row-cols-5">
                        <c:forEach items="${listPlaylist}" var="l">
    ...
    <script>
                                            $(".search_header li ").click(function () {
                                                if ($(this).hasClass("active-search")) {
                                                    $(".search_header li").removeClass("active-search");
                                                } else {
                                                    $(".search_header li").removeClass("active-search");
