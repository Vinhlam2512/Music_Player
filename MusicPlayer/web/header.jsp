        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link <%= this.getClass().getSimpleName().toString().contains("overview") || this.getClass().getSimpleName().toString().contains("songs") || this.getClass().getSimpleName().toString().contains("playList") ? "active" : ""%>" href="./personal/overview.html">Cá Nhân</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <%= this.getClass().getSimpleName().toString().contains("discover") ? "active" : ""%>" href="discover.jsp">Khám Phá </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <%= this.getClass().getSimpleName().toString().contains("zingChart") ? "active" : ""%>" href="./zingChart/zingChart.jsp">ZingChart</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <%= this.getClass().getSimpleName().toString().contains("top100") ? "active" : ""%>" href="./top100.jsp">Top 100</a>
                    </li>
                </ul>
                <div class="d-flex">
                    <form class="d-flex">
