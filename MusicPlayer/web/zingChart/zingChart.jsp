                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                <li class="nav-item">
                                    <a class="nav-link " href="../personal/overview.jsp">Cá Nhân</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="../discover.jsp">Khám Phá</a>
                                </li>
                                <li class="nav-item">
                    ...
                    <div class="chart">
                        ...
                        <div class="chart_type d-flex">
                            <div class="chart_type-country ">
                                <a href="/zingChart/zing-chart-vn" class="active-chart">
                                    <span>VIỆT NAM</span>
                                </a>
                            </div>
                            <div class="chart_type-country">
                                <a href="/zingChart/zing-chart-us-uk">
                                    <span>US-UK</span>
                                </a>
                            </div>
                            <div class="chart_type-country">
                                <a href="/zingChart/zing-chart-kr">
                                    <span>K-POP</span>
                                </a>
                            </div>
                        </div>
                        <div class="chart_content" id="chart_content">
                            ...
                            <c:if test="${html == null}">
                                <div class="show-more" id="show-more">
                                    <a href="./show" class="text-decoration-none" onlick="show(this)">
                                        <span class="show-text ">XEM TOP 100</span>
                                    </a>
                                </div>
                            </c:if>
                        </div>
                                        ...
                                        function showMore() {
                                            $.ajax({
                                                ...
                                                success: function (data) {
                                                    ...
                                                    var content = document.getElementById("chart_content");
