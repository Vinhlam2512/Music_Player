        ...
        <div class="media">
            ...
            <div class="media-right">
                <button id='add1' style="${isLogin ? "" : "display:none"}" >
                    <svg id="unliked" data-id="0" class="unlike-playing" onclick="updateSong('insert',this.getAttribute('data-id'))" style="height: 35px;width: 40px;"  fill="white" height="480pt"
                    ...
                    <svg id="liked" data-id="0" class="like-playing" onclick="updateSong('delete',this.getAttribute('data-id'))" id="Layer_1" style="height: 45px;width: 40px; display: none"  
