                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/musicplayer/kham-pha">Khám Phá</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="../zingChart/zingChart.jsp">ZingChart</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="../top100.jsp">Top 100</a>
                            </li>
                        </ul>
                        <div class="d-flex">
                            <form class="d-flex">
